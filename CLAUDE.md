...
`src/meta.ts` groups the meta pane rows by provenance (EXIF with its Standard
and Maker note sections, and Analysis, whose rows include the focus candidate state and the
