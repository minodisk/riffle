...
- **シャープネス表示**: 各サムネイルの横のバーで、連写のどのコマが最もシャープかがわかります。Sony のボディが顔を追尾していればカメラの瞳 AF 枠で、そうでなければ AF 点の周辺で、カメラが AF 点を記録していなければ顔が見つかれば被写体の目で、それもなければ最もシャープな領域でスコアを取ります。
