...
- This plan's own files (`docs/plans/20260923-american-spelling/`) and its
  review history (`docs/plans/review-history/american-spelling-step-*/`):
  they quote the British forms and the old paths to document the conversion.
...
- [x] Step 2: Convert `docs/plans/**` (the active plans, `_archived/`, and `review-history/`)
  - Done when:
